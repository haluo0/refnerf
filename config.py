...
def config_parser():
    ...
    # general
    parser.add_argument('--config', is_config_file=True, default='/clusterdata/uqwxiang/xsc/tex301/configs/eval_llff.txt',
                        help='eval_nerf_synthetic  pretrain   eval_llff')
    parser.add_argument('--rootdir', type=str,
                        default='/scratch/jcu/ai_group/xsc_data/',
                        help='the path to the project root directory. Replace this path with yours!')
    parser.add_argument('--predir', type=str,
                        default='data/1/pre')
    parser.add_argument('--evaldir', type=str, default='data/out1',
                        help='预训练模型保存处')
    parser.add_argument('--logdir', type=str, default='data/log/',
                        help='tensorboard日志保存路径')
    parser.add_argument("--expname", type=str,default='pretraining', help='experiment name')
    ...
    parser.add_argument("--psnr",  type=int, nargs='+', default=[0,1,3], help='num of iterations')
    parser.add_argument('--flower_2', action='store_true', help='测试场景')
    parser.add_argument('--fortress_3', action='store_true', help='测试场景')
    parser.add_argument('--horns_4', action='store_true', help='测试场景')
    parser.add_argument('--leaves_5', action='store_true', help='测试场景')
    parser.add_argument('--orchids_6', action='store_true', help='测试场景')
    parser.add_argument('--room_7', action='store_true', help='测试场景')
    parser.add_argument('--trex_8', action='store_true', help='测试场景')
    ...
    parser.add_argument("--ckpt_TorF", action='store_true',
                        help='load ckpt_ when reloading')
    ...
    parser.add_argument("--atten_net", type=float, default=1e-3, help='learning rate for feature extractor')
    ...
    parser.add_argument("--i_img", type=int, default=71000, help='frequency of tensorboard image logging')
    parser.add_argument("--i_weights", type=int, default=70000, help='frequency of weight ckpt saving')
    parser.add_argument("--i_val", type=int, default=2000, help='frequency of weight ckpt saving')
